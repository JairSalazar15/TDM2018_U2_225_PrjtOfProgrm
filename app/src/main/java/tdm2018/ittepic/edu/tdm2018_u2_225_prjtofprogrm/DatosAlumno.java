...
public class DatosAlumno extends AppCompatActivity {
    ...
    public void cargarActividad(){
        try {
            ...
            String SQL = "SELECT * FROM ACTIVIDAD WHERE IDALUMNO ="+idusuario+" ORDER BY FECHA_INI ASC";
            ...
            if(resultado.moveToFirst()==true){
                ...
                for(int i=0;i<datos;i++){
                    arreglo[i]="";
                    arreglo[i]= resultado.getString(3)+"      "+ resultado.getString(2);
            ...
            mensajes("¡Atención! Aun no hay actividades ",e.getMessage());
        }
    }
