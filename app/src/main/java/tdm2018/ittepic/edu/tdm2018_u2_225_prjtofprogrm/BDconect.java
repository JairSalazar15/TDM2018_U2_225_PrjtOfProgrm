...
public class BDconect extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE ACTIVIDAD(IDACTIVIDAD INTEGER PRIMARY KEY AUTOINCREMENT,IDALUMNO INTEGER , ACTIVIDAD1 VARCHAR(200), FECHA_INI DATE,FECHA_FIN DATE,CREDITOS INTEGER, FOREIGN KEY (IDALUMNO) REFERENCES ALUMNO(IDALUMNO) )");
